...
import { CommentPostController, CreatePostController, DeletePostController, GetLatestPostsController, GetSinglePostController, GetTop5PostsController, LikePostController } from "../controllers/post.controller";
